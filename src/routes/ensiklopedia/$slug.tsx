    ...
    return (
      <div className="min-h-screen bg-[#FDFBF7] text-[#2A1D15]">
        ...
        <div className="container mx-auto px-6 pt-40 text-center">
          ...
          <p className="mb-8 text-[#543D2A]">
            Aksara yang Anda cari mungkin belum didokumentasikan.
          </p>
          <Link
            to="/ensiklopedia"
            className="text-[#D4AF37] hover:text-[#432818] font-bold tracking-widest uppercase transition-colors"
          >
            ← Kembali ke Daftar
          </Link>
        </div>
  ...
  return (
    <main className="relative min-h-screen bg-[#FDFBF7] text-[#2A1D15] selection:bg-[#D4AF37] selection:text-[#F9F7F2]">
      ...
      <div className="container mx-auto px-6 lg:px-12 pt-32 pb-20 max-w-4xl relative z-10">
        <Link
          to="/ensiklopedia"
          className="inline-flex items-center text-[#543D2A] hover:text-[#D4AF37] mb-12 transition-colors text-xs font-bold tracking-[0.2em] uppercase group"
        >
        ...
        <div className="prose prose-lg prose-headings:font-serif prose-headings:text-[#2A1D15] prose-p:text-[#543D2A] prose-a:text-[#D4AF37] prose-strong:text-[#432818] prose-blockquote:border-[#D4AF37] prose-li:text-[#543D2A] max-w-none">
          {data.description && (
